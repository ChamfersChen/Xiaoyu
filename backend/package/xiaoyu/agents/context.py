...
from xiaoyu.agents.backends.sandbox.paths import sandbox_workspace_agents_prompt_file
...
async def resolve_agent_resource_options(
    ...
    *,
    ...
    if "tools" in fields_to_load:
        from xiaoyu.agents.toolkits.service import get_tool_metadata
    ...
    if "mcps" in fields_to_load:
        from xiaoyu.agents.mcp.service import get_all_mcp_servers
    ...
    if "skills" in fields_to_load:
        from xiaoyu.agents.skills.service import list_accessible_skills
...
async def prepare_agent_runtime_context(
    ...
    *,
    ...
    from xiaoyu.agents.backends.knowledge_base_backend import resolve_visible_knowledge_bases_for_context
    from xiaoyu.agents.middlewares.skills import resolve_runtime_skills_for_context
