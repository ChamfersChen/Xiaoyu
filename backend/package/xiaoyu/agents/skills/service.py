...
from xiaoyu import config as sys_config
from xiaoyu.agents.mcp.service import get_enabled_mcp_server_slugs
from xiaoyu.agents.skills.repository import SkillRepository
from xiaoyu.storage.postgres.models_business import Skill, User
...
def get_builtin_skill_specs() -> list[Any]:
    from xiaoyu.agents.skills.buildin import BUILTIN_SKILLS
...
async def prepare_remote_skill_install(
    ...
    *,
    ...
    from xiaoyu.agents.skills.remote_install import prepare_remote_skills_batch
