...
from xiaoyu.agents.toolkits.registry import ToolExtraMetadata, _all_tool_instances, _extra_registry, tool
from xiaoyu.utils import logger
from xiaoyu.utils.paths import VIRTUAL_PATH_OUTPUTS
from xiaoyu.utils.question_utils import normalize_questions
...
def _normalize_presented_artifact_path(filepath: str, runtime: ToolRuntime) -> str:
    from xiaoyu.agents.backends.sandbox.paths import (
        VIRTUAL_PATH_PREFIX,
        ensure_thread_dirs,
