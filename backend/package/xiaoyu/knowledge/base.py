...
from xiaoyu.knowledge.chunking.ragflow_like.presets import ensure_chunk_defaults_in_additional_params
from xiaoyu.knowledge.schemas import FindOutputSchema, FindWindowSchema, SearchOutputSchema, SearchResultSchema
from xiaoyu.knowledge.utils import resolve_processing_params, sanitize_processing_params
from xiaoyu.utils import logger
from xiaoyu.utils.datetime_utils import coerce_any_to_utc_datetime, utc_isoformat
...
class KnowledgeBase(ABC):
    ...
    async def add_file_record(
        ...
        """
        from xiaoyu.knowledge.utils.kb_utils import prepare_item_metadata
        ...
        if metadata.get("size") is None and content_type == "file":
            try:
                from xiaoyu.knowledge.utils.kb_utils import is_minio_url, parse_minio_url
                from xiaoyu.storage.minio import get_minio_client
    ...
    async def parse_file(self, kb_id: str, file_id: str, operator_id: str | None = None) -> dict:
        ...
        try:
            from xiaoyu.knowledge.parser.unified import Parser
    ...
    async def read_file_preview(self, kb_id: str, file_id: str, variant: str = "parsed") -> dict:
        from xiaoyu.services.file_preview import detect_preview_type
