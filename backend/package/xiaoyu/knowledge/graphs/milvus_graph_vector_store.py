...
from xiaoyu.knowledge.graphs.graph_utils import graph_entity_collection_name, graph_triple_collection_name
from xiaoyu.knowledge.implementations.milvus import CONTENT_ANALYZER_PARAMS, CONTENT_SPARSE_FIELD, VECTOR_METRIC_TYPE
...
class MilvusGraphVectorStore:
    def __init__(self):
        ...
        self.milvus_db = os.getenv("MILVUS_DB") or "xiaoyu"
