...
from xiaoyu.knowledge.base import FileStatus, KnowledgeBase
from xiaoyu.knowledge.chunking.ragflow_like.dispatcher import chunk_markdown
from xiaoyu.knowledge.parser.unified import Parser
from xiaoyu.knowledge.utils.kb_utils import resolve_processing_params
from xiaoyu.models.providers.cache import model_cache
from xiaoyu.repositories.knowledge_chunk_repository import KnowledgeChunkRepository
from xiaoyu.utils import hashstr, logger
...
class MilvusKB(KnowledgeBase):
    ...
    def __init__(self, work_dir: str, **kwargs):
        ...
        self.milvus_db = kwargs.get("milvus_db") or "xiaoyu"
    ...
    def _get_embedding_function(self, embedding_model_spec: str, *, sync: bool = False):
        ...
        from xiaoyu.models.embed import select_embedding_model
    ...
    async def aquery(self, query_text: str, kb_id: str, agent_call: bool = False, **kwargs) -> list[dict]:
        ...
        try:
            ...
            try:
                from xiaoyu.models.rerank import get_reranker
    ...
    async def _retrieve_graph_chunks(
        ...
        try:
            from xiaoyu.knowledge.graphs.milvus_graph_service import MilvusGraphService
            from xiaoyu.knowledge.graphs.milvus_graph_vector_store import MilvusGraphVectorStore
