...
from xiaoyu.knowledge.parser.base import BaseDocumentProcessor
...
class DocumentProcessorFactory:
    ...
    PROCESSOR_TYPES = {
        "rapid_ocr": ("xiaoyu.knowledge.parser.rapid_ocr", "RapidOCRParser"),
        "mineru_ocr": ("xiaoyu.knowledge.parser.mineru", "MinerUParser"),
        "mineru_official": ("xiaoyu.knowledge.parser.mineru_official", "MinerUOfficialParser"),
        "pp_structure_v3_ocr": ("xiaoyu.knowledge.parser.pp_structure_v3", "PPStructureV3Parser"),
        "deepseek_ocr": ("xiaoyu.knowledge.parser.deepseek_ocr", "DeepSeekOCRParser"),
    }
