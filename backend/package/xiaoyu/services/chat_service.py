...
from xiaoyu import config as conf
from xiaoyu.agents.buildin import agent_manager
from xiaoyu.agents.context import build_agent_input_context, normalize_agent_context_config
from xiaoyu.agents.state import AgentStatePayload
from xiaoyu.repositories.agent_repository import AgentRepository
from xiaoyu.repositories.agent_run_repository import AgentRunRepository
from xiaoyu.repositories.conversation_repository import ConversationRepository
from xiaoyu.services.conversation_service import serialize_attachment
from xiaoyu.services.langfuse_service import (
    LangfuseRunContext,
    build_run_context,
    flush_langfuse,
    get_trace_info,
...
from xiaoyu.storage.postgres.models_business import Agent, User
from xiaoyu.utils.guard import content_guard
from xiaoyu.utils.logging_config import logger
from xiaoyu.utils.question_utils import (
...
def _message_chunk_xiaoyu_events(
...
def _protocol_event_xiaoyu_event(
    event: dict[str, Any],
    *,
    message_id: str | None,
    thread_id: str | None,
...
def _message_payload_xiaoyu_events(
    msg: Any,
    *,
    ...
    if isinstance(msg, dict) and isinstance(msg.get("event"), str):
        ...
        stream_event = _protocol_event_xiaoyu_event(
            msg,
            message_id=message_id,
            thread_id=thread_id,
            namespace=namespace,
    ...
    return _message_chunk_xiaoyu_events(
        msg_dict,
        message_id=message_id,
        thread_id=thread_id,
        namespace=namespace,
    ...
    *,
    ...
    try:
        ...
        async for mode, payload in _stream_agent_events(
            ...
            stream_events = _message_payload_xiaoyu_events(
                msg,
                metadata=metadata,
                namespace=namespace,
