...
JWT_AUDIENCE = "xiaoyu-know-api"
PUBLIC_DEFAULT_JWT_SECRET_KEY = "xiaoyu_know_secure_key"
PASSWORD_HASHER = PasswordHasher()


def _is_production_env() -> bool:
    return os.environ.get("XIAOYU_ENV", "development").strip().lower() in {"prod", "production"}
...
def _get_jwt_issuer() -> str:
    instance_id = _get_or_create_dev_env("XIAOYU_INSTANCE_ID", lambda: f"instance-{secrets.token_hex(8)}")
    return f"xiaoyu-know:{instance_id}"
