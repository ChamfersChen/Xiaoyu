...
from xiaoyu.storage.postgres.models_business import User, Department
from xiaoyu.repositories.user_repository import UserRepository
from xiaoyu.repositories.department_repository import DepartmentRepository
...
from xiaoyu.utils.auth_utils import AuthUtils
from xiaoyu.services.user_identity_service import generate_unique_uid, validate_username, is_valid_phone_number
from xiaoyu.services.operation_log_service import log_operation
from xiaoyu.storage.minio import upload_image_to_minio
from xiaoyu.utils.datetime_utils import utc_now_naive

# OIDC 认证相关导入
from xiaoyu.services.oidc_service import (
