...
from xiaoyu.services.task_service import TaskContext, tasker
from server.utils.auth_middleware import get_admin_user, get_required_user
from xiaoyu import config, knowledge_base
from xiaoyu.knowledge.factory import KnowledgeBaseFactory
from xiaoyu.knowledge.graphs.milvus_graph_service import GRAPH_TASK_TYPE, MilvusGraphService
from xiaoyu.knowledge.parser import Parser, SUPPORTED_FILE_EXTENSIONS, is_supported_file_extension
from xiaoyu.knowledge.utils import calculate_content_hash, is_minio_url, parse_minio_url
from xiaoyu.knowledge.utils.mindmap_utils import (
    generate_database_mindmap,
    get_database_mindmap_data,
    get_mindmap_database_files,
    get_mindmap_databases_overview,
)
from xiaoyu.knowledge.utils.sample_question_utils import (
    generate_database_sample_questions,
    get_database_sample_questions,
)
from xiaoyu.knowledge.utils.url_fetcher import fetch_url_content
from xiaoyu.models.providers.cache import model_cache
from xiaoyu.utils.upload_utils import MAX_UPLOAD_SIZE_BYTES, read_upload_with_limit, write_upload_to_path
from xiaoyu.services.workspace_service import MAX_WORKSPACE_UPLOAD_SIZE_BYTES, resolve_workspace_file_path
from xiaoyu.storage.postgres.models_business import User
from xiaoyu.storage.minio.client import MinIOClient, StorageError, aupload_file_to_minio, get_minio_client
...
async def create_database(
    ...
    try:
        ...
        # 需要重新加载所有智能体，因为工具刷新了
        from xiaoyu.agents.buildin import agent_manager
...
async def update_knowledge_base_query_params(
    ...
    try:
        ...
        from xiaoyu.repositories.knowledge_base_repository import KnowledgeBaseRepository
...
async def generate_description(
    ...
    """
    from xiaoyu.models import select_model
