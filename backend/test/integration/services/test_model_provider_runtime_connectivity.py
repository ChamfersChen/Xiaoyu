...
from xiaoyu.models.chat import OpenAIBase
from xiaoyu.models.embed import OtherEmbedding
from xiaoyu.models.rerank import DashscopeReranker, OpenAIReranker
from xiaoyu.models.providers.service import (
    resolve_api_key,
    ensure_builtin_model_providers_in_db,
    get_model_provider_by_id,
)
from xiaoyu.storage.postgres.manager import pg_manager
from xiaoyu.storage.postgres.models_business import ModelProvider
...
async def test_provider_db_rerank_model_connectivity():
    ...
    scores = await reranker.acompute_score(("Xiaoyu knowledge base", ["Xiaoyu is a RAG platform.", "Unrelated text."]))
