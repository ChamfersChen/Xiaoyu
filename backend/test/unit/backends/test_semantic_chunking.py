...
from xiaoyu.knowledge.chunking.ragflow_like.parsers import semantic
from xiaoyu.models import select_embedding_model
...
def test_heading_inference():
    """测试标题层级推断工具类"""
    from xiaoyu.knowledge.chunking.ragflow_like.utils.md_parser_utils import infer_heading_level
