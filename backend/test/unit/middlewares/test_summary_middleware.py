...
from xiaoyu.agents.backends.composite import create_agent_composite_backend
from xiaoyu.agents.middlewares.summary import create_summary_middleware
...
@pytest.mark.unit
def test_create_summary_middleware_uses_deepagents_with_xiaoyu_outputs_root() -> None:
