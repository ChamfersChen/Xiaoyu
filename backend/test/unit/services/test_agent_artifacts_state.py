...
from xiaoyu.agents.state import merge_artifacts
from xiaoyu.agents.toolkits.buildin.tools import _normalize_presented_artifact_path
from xiaoyu.services.chat_service import extract_agent_state
