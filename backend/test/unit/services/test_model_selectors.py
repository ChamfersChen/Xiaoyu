...
from xiaoyu.agents.models import load_chat_model, resolve_chat_model_spec
from xiaoyu.models.chat import select_model
from xiaoyu.models.embed import OtherEmbedding, select_embedding_model
from xiaoyu.models.rerank import OpenAIReranker, get_reranker
from xiaoyu.models.providers.cache import ModelInfo
...
def test_resolve_chat_model_spec_prefers_explicit_then_fallback_then_default(monkeypatch):
    monkeypatch.setattr("xiaoyu.agents.models.sys_config.default_model", "system-default:model")
...
def test_resolve_chat_model_spec_rejects_all_empty(monkeypatch):
    monkeypatch.setattr("xiaoyu.agents.models.sys_config.default_model", "")
...
def test_select_embedding_model_loads_model_from_cache(monkeypatch):
    monkeypatch.setattr(
        "xiaoyu.models.embed.model_cache.get_model_info",
...
def test_embedding_sync_400_logs_warning(monkeypatch):
    ...
    monkeypatch.setattr("xiaoyu.models.embed.requests.post", fake_post)
...
def test_embedding_sync_429_retries_ten_times_before_success(monkeypatch):
    warnings = _capture_embed_warnings(monkeypatch)
    sleeps = []
    monkeypatch.setattr("xiaoyu.models.embed.time.sleep", sleeps.append)
    ...
    monkeypatch.setattr("xiaoyu.models.embed.requests.post", lambda *_args, **_kwargs: responses.pop(0))
...
async def test_embedding_async_400_logs_warning(monkeypatch):
    ...
    monkeypatch.setattr("xiaoyu.models.embed.httpx.AsyncClient", FakeAsyncClient)
...
async def test_embedding_async_429_retries_ten_times_before_success(monkeypatch):
    ...
    monkeypatch.setattr("xiaoyu.models.embed.asyncio.sleep", fake_sleep)
...
def test_get_reranker_loads_model_from_cache(monkeypatch):
    monkeypatch.setattr(
        "xiaoyu.models.rerank.model_cache.get_model_info",
