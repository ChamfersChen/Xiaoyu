...
nlp.py / general.py 只依赖 re 和标准库，用 sys.modules 占位绕过 xiaoyu 包的
...
_STUB_NAMES = [
    "xiaoyu",
    "xiaoyu.knowledge",
    "xiaoyu.knowledge.chunking",
    "xiaoyu.knowledge.chunking.ragflow_like",
    "xiaoyu.knowledge.chunking.ragflow_like.parsers",
    "xiaoyu.knowledge.chunking.ragflow_like.nlp",
    "xiaoyu.knowledge.chunking.ragflow_like.parsers.general",
]
...
def _isolated_modules():
    ...
    _nlp = _load(
        "xiaoyu.knowledge.chunking.ragflow_like.nlp",
        "xiaoyu/knowledge/chunking/ragflow_like/nlp.py",
    )
    sys.modules["xiaoyu.knowledge.chunking.ragflow_like"].nlp = _nlp  # type: ignore[attr-defined]

    _general = _load(
        "xiaoyu.knowledge.chunking.ragflow_like.parsers.general",
        "xiaoyu/knowledge/chunking/ragflow_like/parsers/general.py",
    )
