...
os.environ.setdefault("SAVE_DIR", os.path.join(os.environ.get("CLAUDE_JOB_DIR", tempfile.gettempdir()), "xiaoyu-test-saves"))

from xiaoyu.services import conversation_service as service
