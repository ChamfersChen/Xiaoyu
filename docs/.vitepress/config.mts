...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        text: '简介',
        items: [
          { text: '什么是 Xiaoyu？', link: '/intro/project-overview' },
          { text: '快速开始', link: '/intro/quick-start' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/xerrors/Xiaoyu' }
    ],

    footer: {
      message: '本项目基于 MIT License 开源，欢迎使用和贡献。',
      copyright: 'Copyright © 2025-present Xiaoyu'
    },

    editLink: {
      pattern: 'https://github.com/xerrors/Xiaoyu/edit/main/docs/:path',
      text: '在 GitHub 上编辑此页'
    },
