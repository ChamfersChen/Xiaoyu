...
const GITHUB = 'https://github.com/xerrors/Xiaoyu'
  ...
  <div class="yx-home">
    ...
    <section class="yx-hero">
      ...
      <div class="yx-container yx-hero__inner">
        <span class="yx-badge">v0.1.0 · MIT 开源 · LangGraph 驱动</span>
        <h1 class="yx-hero__title">晓喻 <span class="yx-accent">Xiaoyu</span></h1>
    ...
    <section class="yx-section">
      <div class="yx-container">
        <header v-reveal class="yx-head">
          ...
          <p class="yx-head__sub">Xiaoyu 内置一套完整的 Harness——沙盒、技能、工具、子智能体与中间件，让智能体真正动手完成任务。</p>
        </header>
        <div class="yx-bento">
          <article
...
git clone --branch v0.1.0 --depth 1 https://github.com/xerrors/Xiaoyu.git
cd Xiaoyu && ./scripts/init.sh
    ...
    <section class="yx-section yx-section--soft">
      <div class="yx-container yx-center">
        ...
        <a v-reveal :href="GITHUB + '/graphs/contributors'" target="_blank" rel="noreferrer" class="yx-contrib">
          <img src="https://contrib.rocks/image?repo=xerrors/Xiaoyu&max=60&columns=12" alt="Xiaoyu 贡献者头像墙" loading="lazy" />
        </a>
