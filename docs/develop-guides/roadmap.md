...
路线图可能会经常变更，如果有强烈的建议，可以在 [issue](https://github.com/xerrors/Xiaoyu/issues) 中提。
...
**仅设想**
- [ ] Xiaoyu-cli 相关的功能，放在后续版本中实现（不是类似于编程助手，而是管理平台的工，等各个 router 接口优化之后）
- [ ] Xiaoyu-cli 支持 `xiaoyu upload <DIR_NAME>`，将本地文件夹上传到系统中
