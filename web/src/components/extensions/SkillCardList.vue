...
const rememberRemoteSource = (source) => {
  ...
  localStorage.setItem('xiaoyu_remote_repo_history', JSON.stringify(history))
}
...
const loadHistory = () => {
  try {
    const raw = localStorage.getItem('xiaoyu_remote_repo_history')
    if (raw) {
...
const deleteHistoryItem = (item) => {
  ...
  localStorage.setItem('xiaoyu_remote_repo_history', JSON.stringify(repoHistory.value))
}

const clearAllHistory = () => {
  repoHistory.value = []
  localStorage.removeItem('xiaoyu_remote_repo_history')
