...
const fetchGithubStars = async () => {
  try {
    ...
    // 公共API，可以直接使用fetch
    const response = await fetch('https://api.github.com/repos/xerrors/Xiaoyu')
...
const organizationName = computed(() => {
  return infoStore.organization.name || infoStore.branding.name || 'Xiaoyu'
})
      ...
      <div class="foo">
        <div class="github nav-item" @click.stop>
          <a-tooltip placement="right" :open="sidebarCollapsed ? undefined : false">
            ...
            <a href="https://github.com/xerrors/Xiaoyu" target="_blank" class="github-link">
